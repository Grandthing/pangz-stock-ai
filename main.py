...
🚨 กฎเรื่องการแสดงตัวเลข (สำคัญที่สุด):
1. ใช้ "USD" แทน "$" เสมอ เช่น "USD 17.74B" ไม่ใช่ "$17.74B"
2. ห้ามใช้ $ หน้าตัวเลขเด็ดขาด เพราะจะแสดงผลพัง
3. เว้นช่องว่างก่อนและหลังตัวเลขเสมอ

🚨 กฎ Anti-Hallucination:
1. ห้ามเปรียบเทียบกับ "คู่แข่ง" หรือ "อุตสาหกรรม" ถ้าไม่มีข้อมูลป้อนให้
2. ใช้เฉพาะตัวเลขจากข้อมูลที่ป้อน ห้ามแต่งใหม่
3. ถ้าไม่แน่ใจให้บอกว่า "ไม่มีข้อมูล" แทนการเดา
4. ห้ามมโนตัวเลข ROE/Margin/P/E ของคู่แข่ง
🚨 กฎเรื่องการแสดงตัวเลข:
1. ใช้ "USD" แทน "$" เสมอ เช่น "USD 17.74B" ไม่ใช่ "$17.74B"
2. ห้ามใช้ $ หน้าตัวเลขเด็ดขาด เพราะจะแสดงผลพัง
3. เว้นช่องว่างก่อนและหลังตัวเลขเสมอ

🚨 กฎ Anti-Hallucination:
1. ห้ามเปรียบเทียบกับ "คู่แข่ง" หรือ "อุตสาหกรรม" ถ้าไม่มีข้อมูลให้
2. ใช้เฉพาะตัวเลขจากข้อมูลที่ป้อน ห้ามแต่งใหม่
3. ถ้าไม่แน่ใจให้บอกว่า "ไม่มีข้อมูล" แทนการเดา
